...
!function(e) {
    ...
    e.isNode = "undefined" != typeof module && !!module.exports,
    ...
    e.isWebWorker = "function" == typeof e.global.importScripts,
    e.isElectronRenderer = "undefined" != typeof process && "undefined" != typeof process.versions && "undefined" != typeof process.versions.electron && "renderer" === process.type,
    e.isElectronMain = "undefined" != typeof process && "undefined" != typeof process.versions && "undefined" != typeof process.versions.electron && "browser" === process.type,
    e.hasPerformanceNow = e.global.performance && "function" == typeof e.global.performance.now
}(AMDLoader || (AMDLoader = {}));
var AMDLoader;
!function(e) {
    function t() {
    ...
    }(r = e.LoaderEventType || (e.LoaderEventType = {})),
    e.getHighPerformanceTimestamp = t;
    var n = function() {
        function e(e, t, r) {
            this.type = e,
            this.detail = t,
...
!function(e) {
    var t = function() {
        ...
        return t.validateConfigurationOptions = function(t) {
            ...
            "function" != typeof t.onNodeCachedDataError && (t.onNodeCachedDataError = function(e) {
                "cachedDataRejected" === e.errorCode ? console.warn("Rejected cached data from file: " + e.path) : "unlink" !== e.errorCode && "writeFile" !== e.errorCode || (console.error("Problems writing cached data file: " + e.path),
                console.error(e.detail))
            }
            ),
            t
    ...
    var r = function() {
        function r(r) {
            if (this.options = t.mergeConfigurationOptions(r),
...
!function(e) {
    var t = function() {
        ...
        return e.prototype.load = function(e, t, r, n) {
            ...
            return this.callbackMap.hasOwnProperty(t) ? void this.callbackMap[t].push(i) : (this.callbackMap[t] = [i],
            void this.actualScriptLoader.load(e, t, function() {
      ...
      , o = function() {
        ...
        t.prototype.load = function(r, n, o, i) {
            ...
            if (/^node\|/.test(n)) {
                ...
                n = e.Utilities.fileUriToFilePath(n),
                this._fs.readFile(n, {
                    encoding: "utf8"
                }, function(a, c) {
                    if (a)
                    ...
                    if (e.isElectronRenderer) {
                        var p = f.match(/^([a-z])\:(.*)/i);
                        p && (f = p[1].toUpperCase() + ":" + p[2]),
                        f = "file:///" + f.replace(/\\/g, "/")
                    }
                    var h, g = "(function (require, define, __filename, __dirname) { ", v = "\n});";
                    if (h = c.charCodeAt(0) === t._BOM ? g + c.substring(1) + v : g + c + v,
                    h = u(h, f),
                    d.nodeCachedDataDir) {
                        ...
                        s._fs.readFile(_, function(e, i) {
                            ...
                            o(),
                            u.cachedDataRejected ? (d.onNodeCachedDataError({
        ...
        t.prototype._loadAndEvalScript = function(t, r, n, o, i) {
            ...
            return d.call(e.global, e.RequireFunc, e.DefineFunc, r, this._path.dirname(t)),
            i.record(e.LoaderEventType.NodeEndEvaluatingScript, t),
            s
        }
        ,
    ...
    o._BOM = 65279,
    e.scriptLoader = new t(e.isWebWorker ? new n : e.isNode ? new o : new r)
}(AMDLoader || (AMDLoader = {}));
var AMDLoader;
!function(e) {
    var t = function() {
        ...
        t.prototype.complete = function(r, n, o) {
            ...
            if (this._callback)
                if ("function" == typeof this._callback) {
                    ...
                    i || "undefined" == typeof s.returnedValue || this.exportsPassedIn && !e.Utilities.isEmpty(this.exports) || (this.exports = s.returnedValue)
                } else
    ...
    var n = function() {
        ...
        e.prototype.getModuleId = function(e) {
            ...
            return "undefined" == typeof t && (t = this._nextId++,
    ...
    var s = function() {
        function s(t, r) {
            void 0 === r && (r = 0),
            this._recorder = null,
            this._loaderAvailableTimestamp = r,
            this._moduleIdProvider = new n,
            this._config = new e.Configuration,
        ...
        s.prototype.configure = function(t, r) {
            ...
            r ? this._config = new e.Configuration(t) : this._config = this._config.cloneAndMerge(t),
                  ...
                  , s = function(n) {
                    ...
                    i >= o.length)
                        ...
                        if (r._config.isBuild() && "empty:" === d)
                            return r._buildInfoPath[t] = d,
                            r.defineModule(r._moduleIdProvider.getStrModuleId(t), [], null, null, null),
                            void r._onLoad(t);
                        a.record(e.LoaderEventType.BeginLoadingScript, d),
                        r._scriptLoader.load(r, d, function() {
                            r._config.isBuild() && (r._buildInfoPath[t] = d),
                            a.record(e.LoaderEventType.EndLoadingScriptOK, d),
                            r._onLoad(t)
                        }, function(t) {
                            a.record(e.LoaderEventType.EndLoadingScriptError, d),
                            s(t)
                        })
                    }
                };
...
!function(e) {
    function t() {
        if (r = new e.ModuleManager(e.scriptLoader,n),
        e.isNode) {
        ...
        e.isNode && !e.isElectronRenderer ? (module.exports = i,
        define = function() {
            o.apply(null, arguments)
        }
        ,
        require = i) : ("undefined" != typeof e.global.require && "function" != typeof e.global.require && i.config(e.global.require),
        e.isElectronRenderer ? define = function() {
            o.apply(null, arguments)
        }
        : e.global.define = define = o,
        e.global.require = i,
        e.global.require.__$__nodeRequire = s)
    }
    var r, n, o = function() {
        function e(e, t, n) {
            "string" != typeof e && (n = t,
    ...
    e.RequireFunc = i,
    "function" == typeof e.global.define && e.global.define.amd || (t(),
